  ...
  class PlayGame extends ErtaoGameScene {
    ...
    create () {
      ...
      for (let i = 0; i < frames.length; i++) {
        ...
        //
        let img = this.add.image(x, y, 'megaset', frames[i]).setOrigin(0.5, 0);
        //
        this.imgGroup.add(img);
        //
        window.imgGroup = this.imgGroup;
      }
      ...
      //
      this.add.text(32, 32, str, {font: '20px Courier', fill: '#00ff00'});
    }

    update () {
      Phaser.Actions.RotateAround(this.imgGroup.getChildren(), {x: 400, y: 300}, 0.01);
      // Phaser.Actions.RotateAroundDistance(this.imgGroup.getChildren(), {x: 400, y: 300}, 0.02, 300);
    }
