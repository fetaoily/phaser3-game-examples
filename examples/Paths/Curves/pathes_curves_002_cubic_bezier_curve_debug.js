(() => {
  ...
  class PlayGame extends ErtaoGameScene {
    ...
    update () {
      ...
      //
      let t1 = this.line1.getPoint(this.path.t);
      let t2 = this.line2.getPoint(this.path.t);
      let t3 = this.line3.getPoint(this.path.t);
      //
      ...
      //
      let t4 = this.line4.getPoint(this.path.t);
      let t5 = this.line5.getPoint(this.path.t);
      //
